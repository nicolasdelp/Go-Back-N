...
public class Demo {
    ...
    public static void main(String [] args)
    {
    	...
    	try {
    		...
    		host1.getIPLayer().addRoute(IP_ADDR2, "eth0"); //Route entre les 2 noeuds
    		host1.addApplication(new AppSender(host1, IP_ADDR2)); //On lui ajoute son application d'envoie

    		IPHost host2= NetworkBuilder.createHost(network,"H2", IP_ADDR2, MAC_ADDR2); //On crée le second noeud
    		host2.getIPLayer().addRoute(IP_ADDR1, "eth0"); //Route entre les 2 noeuds
